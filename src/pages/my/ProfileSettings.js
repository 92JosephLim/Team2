        ...
        <main className="flex-1 p-6 max-w-4xl mx-auto bg-white rounded-lg shadow-md">
          <div className="profile-settings-content">
            ...
            <form className="profile-settings-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group mb-6">
                <label className="block text-lg font-medium text-gray-700">현재 비밀번호</label>
                <input 
                  type="password" 
                  name="password" 
              ...
              <div className="form-group mb-6">
                <label className="block text-lg font-medium text-gray-700">새 비밀번호</label>
                <input 
                  type="password" 
                  name="newPassword" 
              ...
              <div className="form-group mb-6">
                <label className="block text-lg font-medium text-gray-700">새 비밀번호 확인</label>
                <input 
                  type="password" 
