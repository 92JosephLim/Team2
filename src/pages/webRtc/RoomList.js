...
function RoomList() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-900">
      <div className="p-6 bg-gray-800 rounded-lg shadow-lg w-full max-w-5xl">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
          <h1 className="text-2xl font-bold text-white mb-4 sm:mb-0">방 목록</h1>
      ...
      {isRoomNumberBoxOpen && (
        ...
        >
          <div className="bg-gray-700 p-6 rounded shadow-lg w-80" onClick={(e) => e.stopPropagation()}>
            <h2 className="text-xl font-semibold mb-4 text-white">방 번호를 입력하세요</h2>
            <input
              type="text"
              placeholder="방 번호"
