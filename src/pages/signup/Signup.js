...
function Signup() {
  ...
  const onChangePassword = (e) => {
    ...
    if (!passwordRegTest.test(currentPassword)) {
      setMessages({
        ...messages,
        passwordMessage: "영어 대소문자, 특수문자, 숫자를 조합해 8자리 이상 20자리 이하로 입력해주세요!",
      });
          ...
          <div className="bg-white lg:w-4/12 md:6/12 w-10/12 m-auto my-10 mt-5">
            <div className="py-8 px-8 rounded-xl">
              ...
              <form onSubmit={handleSUSubmit} className="mt-6">
                ...
                {isCodeInputVisible && (
                  <div className="my-5 text-sm">
                    ...
                    <div className="flex justify-end flex mt-3">
                      ...
                      <p className="timer mt-1 text-red-600 text-xl grid place-items-center ml-5">
                        {min}분{sec}초
                      </p>
                    </div>
                  </div>
                ...
                <div className="my-5 text-sm">
                  <label htmlFor="nickName" className="block text-black text-left">
                    Nickname
                  </label>
                  <input
                    type="text"
                ...
                <div className="my-5 text-sm">
                  <FormControl fullWidth>
                    ...
                    >
                      ...
                      <MenuItem value="spanish">스페인어</MenuItem>
                      <MenuItem value="arabic">아랍어</MenuItem>
                    </Select>
                  </FormControl>
                </div>
                <div className="my-5 text-sm">
                  <label htmlFor="profilePicture" className="block text-black text-left">
                    Profile Image
                  </label>
                  <input
                    type="file"
                ...
                <button
                  ...
                  type="submit"
                  disabled={
                    !validity.isEmail || !validity.isPassword || !validity.isPasswordCheck || !validity.isPhoneNumber
                  }
                >
                  회원가입
                </button>
              ...
              <p className="mt-12 text-xl text-center font-light text-gray-400">
                계정이 있으신가요?{" "}
                <span onClick={() => navigate("/login")} className="text-blue-800 font-semibold cursor-pointer">
                  로그인하기
                </span>
              </p>
            </div>
