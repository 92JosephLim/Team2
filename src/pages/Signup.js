...
//                 </div>
//                 <button
//                   className={`block text-center text-white p-3 duration-300 rounded-sm w-full ${!validity.isEmail || !validity.isPassword || !validity.isPasswordCheck || !validity.isPhoneNumber ? 'bg-gray-400 cursor-not-allowed' : 'bg-gray-800 hover:bg-black'
//                     }`}
//                   type="submit"
...
//       setValidity({ ...validity, isEmail: false });
//     } else {
//       setMessages({ ...messages, emailMessage: "사용할 수 있는 이메일입니다." });
//       setValidity({ ...validity, isEmail: true });
//     }
//   };
...
//       } else {
//         setMessages({ ...messages, emailMessage: "인증 이메일이 전송되었습니다." });
//         setModalMessage("인증 이메일이 전송되었습니다");
//         setModalIsOpen(true);
//       }
//     } catch (error) {
//       setMessages({ ...messages, emailMessage: "서버 오류로 이메일을 확인할 수 없습니다." });
